    ...
    e.prototype = {
        _init: function() {
            ...
            b.$element.find(".pogoSlider-slide").each(function() {
                ...
                b.slides.push(f)
            }), b.numSlides = b.slides.length, b.slides[0].$element.css("opacity", 1), b.settings.autoplay && b.settings.displayProgess && b._createProgessBar(), b.$element.css("", 100 / (b.settings.targetWidth / b.settings.targetHeight) + "%");
